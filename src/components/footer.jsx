            ...
            <div className='flex '>
                <div className='w-[620px] h-[282px] my-19 mx-auto px-2 flex flex-col gap-10'>
                    <div className='mx-auto text-center flex flex-col gap-4'>
                        ...
                        <p className='font-inter text-[16px] text-black/60 px-6.9'>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>
                    </div>
